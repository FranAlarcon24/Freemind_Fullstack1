...
public class InstitucionController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Institucion> patchInstitucion(@PathVariable Integer id, @RequestBody Institucion institucion){
        Institucion patchedInstitucion = institucionService.patchInstitucion(id, institucion);
        if(patchedInstitucion == null){
            return ResponseEntity.notFound().build();
        }
        return ResponseEntity.ok(patchedInstitucion);
    }
