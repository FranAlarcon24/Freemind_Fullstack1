...
public class TipoUsuarioController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<TipoUsuario> patchTipoUsuario(@PathVariable Integer id, @RequestBody TipoUsuario tipoUsuario){
        TipoUsuario patchedTipoUsuario = tipoUsuarioService.patchTipoUsuario(id, tipoUsuario);
        if (patchedTipoUsuario == null){
            return ResponseEntity.notFound().build();
        }
        return ResponseEntity.ok(patchedTipoUsuario);
    }
